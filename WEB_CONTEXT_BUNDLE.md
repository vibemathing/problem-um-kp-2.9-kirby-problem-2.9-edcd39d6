...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-2.9-kirby-problem-2.9-edcd39d6-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-2.9"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-2.9-kirby-problem-2.9-edcd39d6-v1",
      "problem_contract_sha256": "5b358e2929fb2902d705b760d0b22dfb801d79223f84db4d176b00a744f4462b",
      "problem_id": "problem:um-kp-2.9-kirby-problem-2.9-edcd39d6",
      "route_id": "route:um-kp-2.9-kirby-problem-2.9-edcd39d6-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-2.9-kirby-problem-2.9-edcd39d6-source-fidelity-01",
      "graph_id": "graph:um-kp-2.9-kirby-problem-2.9-edcd39d6-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-2.9-kirby-problem-2.9-edcd39d6-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-2.9-kirby-problem-2.9-edcd39d6-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is there a nice presentation of the $n$-stranded braid group whose generating set is the set of all positive elementary braid half-twists?"
          },
          "statement_sha256": "2416c596641be700da517339b68c32c9e86a6d7ca862e73319f2daf76890e39d"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-2.9-kirby-problem-2.9-edcd39d6-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-2.9-kirby-problem-2.9-edcd39d6-root",
      "route_id": "route:um-kp-2.9-kirby-problem-2.9-edcd39d6-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-2.9-1dd9e364da4b",
        "url": "https://www.unsolvedmath.com/problems/KP-2.9"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
